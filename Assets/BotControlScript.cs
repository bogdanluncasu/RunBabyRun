...
public class BotControlScript : MonoBehaviour
{
	...
	static int idleState = Animator.StringToHash("Kyle.Idle");	
	static int locoState = Animator.StringToHash("Kyle.Locomotion");			// these integers are references to our animator's states
	static int jumpState = Animator.StringToHash("Kyle.Jump");				// and are used to check state for various actions to occur
	static int jumpDownState = Animator.StringToHash("Kyle.JumpDown");		// within our FixedUpdate() function below
	static int fallState = Animator.StringToHash("Kyle.Fall");
	static int rollState = Animator.StringToHash("Kyle.Roll");
